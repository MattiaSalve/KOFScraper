...
def postprocessing(cwd=None):
    ...
    # delete chunks
    extension = 'csv'
    chunk_files = [fn for fn in glob.glob(
        '*.{}'.format(extension)) if fn.split("_")[0] == "url"]
    ...
    print("Time needed for postprocessing: ", str(
